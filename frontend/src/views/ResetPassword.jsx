...
function ResetPassword() {
  ...
  return (
    <div className="requestbg  flex items-center justify-center">
      <div className=" z-10  flex min-h-screen overflow-hidden justify-center items-center  ">
        <div className="flex flex-col   items-center justify-center px-8 pb-8 ">
          {showNewPasswordForm ? (
            ...
            <div className="w-[300px] py-6 flex flex-col items-center justify-center pt-4 pb-8 shadow-lg rounded-2xl bg-white bg-opacity-10">
              <img className="h-16  mb-4" src="/logo2.png" alt="logo" />
              ...
              >
                ...
                />
                {message && (
                  <div className="text-red-700  rounded-lg  flex items-center justify-between w-full">
                    <button onClick={() => setMessage(null)}>
                      <svg
                        className="w-6 h-6 mr-2"
                        fill="none"
